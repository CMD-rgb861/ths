...
// --- Compare Modal for Software Name History ---
function SoftwareNameCompareModal({
  isOpen,
  onClose,
  jobs = [],
  currentJob,
  ...
  const getSoftwareName = (job) =>
    job?.action_report?.software_name || job?.software_name || '—';
        ...
        {!job ? (
          ...
          <div className="space-y-4">
            <Section title="Summary">
              ...
              <InfoField label="Software Name" value={getSoftwareName(job)} strong />
...
// --- Main SoftwareNameSearch component ---
export default function SoftwareNameSearch({ value, onChange, readOnly, currentJob }) {
  ...
  useEffect(() => {
    ...
    debounceRef.current = setTimeout(() => {
      axios
        .get('/software-name/search', {
          params: {
            software_name: trimmed,
  ...
  // Prepare a "new job" object for the compare modal
