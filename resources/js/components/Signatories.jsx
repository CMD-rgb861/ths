...
const Signatories = ({ showNotification }) => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-6">
        <h1 className="text-2xl font-bold text-gray-900">Signatories (IT Director)</h1>
        <p className="text-gray-600 mt-1">Set the IT Director name used for approvals and unserviceable reports</p>
      </div>
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                ...
                <div>
                  <p className="text-xs font-semibold text-blue-900 uppercase tracking-wide">Current IT Director</p>
              ...
              >
                <svg className={`w-3.5 h-3.5 mr-1 ${refreshing ? 'animate-spin' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
